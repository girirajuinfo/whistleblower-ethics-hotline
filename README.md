...
--Day 12: Data Seeding and UI Guidelines
Added DataSeeder to insert 30 sample complaints on startup
Prevented duplicate data using database check
Enabled easy API and pagination testing
Verified data in database and API responses
Defined basic UI guidelines for future frontend
